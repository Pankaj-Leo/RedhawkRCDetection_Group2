...
#     return undistorted
#
# def main(calibration_file='calibration_data.npz', width=1280, height=720):
#     """Main function to run the camera undistortion."""
#     mtx, dist = load_calibration_data(calibration_file)  # Load calibration data
#     cap = initialize_camera(width, height)  # Initialize the camera
#
#     try:
#         while True:
#             ret, frame = cap.read()
